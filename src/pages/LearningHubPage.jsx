          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-4 sm:gap-6 animate-landing-up">
              ...
              <h1 className="text-2xl xs:text-3xl sm:text-5xl lg:text-6xl font-black text-white font-heading tracking-tight leading-[1.15]">
                ...
                <span className="gold-gradient-text animate-gradient-text">Market Learning Hub</span>
              </h1>

              <p className="text-xs sm:text-base text-slate-100 font-semibold leading-relaxed p-4 sm:p-5 rounded-2xl bg-[#0B192C]/95 border border-amber-500/30 shadow-2xl backdrop-blur-md max-w-xl">
            ...
            <div className="lg:col-span-5 animate-scale-in">
              <div className="relative group">
                ...
                <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-amber-500/30 shadow-2xl bg-[#050E1A]">
                  <img
                  ...
                  <div className="absolute top-4 left-4 right-4 flex items-center justify-between pointer-events-none">
                    <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#050E1A]/90 border border-amber-500/40 text-amber-400 text-[10px] sm:text-xs font-mono font-bold backdrop-blur-md shadow-xl">
                  ...
                  <Link 
                    ...
                    className="absolute inset-x-4 bottom-4 p-3.5 sm:p-4 rounded-2xl bg-[#0B192C]/95 border border-amber-500/40 backdrop-blur-xl flex flex-col gap-1.5 text-left shadow-2xl hover:border-amber-400 transition-all cursor-pointer group/link"
                  >
                    ...
                    <h3 className="text-xs sm:text-sm font-black text-white font-heading group-hover/link:text-amber-400 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8 text-left">
            {filtered.map((article, idx) => (
              <ScrollReveal key={article.id} animation="fade-up" delay={idx * 100}>
                <div className="p-5 sm:p-7 rounded-2xl sm:rounded-3xl bg-white border border-slate-200/90 shadow-2xs flex flex-col justify-between gap-5 sm:gap-6 group hover:border-amber-400 hover:shadow-xl transition-all h-full">
                  <div className="flex flex-col gap-3.5 sm:gap-4">
                    <div className="flex items-center justify-between">
                      ...
                      <BookOpen className="w-4 h-4 text-slate-400 group-hover:text-amber-600 transition-colors shrink-0" />
                    </div>

                    <h2 className="text-base sm:text-lg font-black text-[#0B192C] font-heading leading-snug group-hover:text-amber-600 transition-colors">
                      {article.title}
                    </h2>
                  ...
                  <Link
                    ...
                    className="w-full py-2.5 sm:py-3 rounded-xl bg-slate-50 border border-slate-200 hover:bg-[#0B192C] hover:text-white text-[#0B192C] font-extrabold text-xs text-center transition-all flex items-center justify-center gap-2 mt-2 sm:mt-4"
                  >
