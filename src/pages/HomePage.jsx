        ...
        <div className="max-w-7xl mx-auto px-3.5 sm:px-6 relative z-10 my-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start gap-4 sm:gap-6 text-left animate-landing-up">
              ...
              {/* Live Signal Badge */}
              <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full futuristic-glass-card text-amber-400 text-[10.5px] sm:text-xs font-extrabold uppercase tracking-wider badge-3d cursor-default max-w-full">
                ...
                <span className="truncate">Professional Trading Academy</span>
              </div>

              {/* Main Headline */}
              <h1 className="text-xl xs:text-2xl sm:text-5xl lg:text-6xl font-black text-white leading-tight sm:leading-[1.15] font-heading tracking-tight">
                Master the Markets. <span className="gold-gradient-text animate-gradient-text">Trade with Discipline.</span> <span className="text-slate-100">Protect Your Capital.</span>
              </h1>

              {/* Paragraph Copy */}
              <p className="text-xs sm:text-sm text-slate-200 font-semibold leading-relaxed max-w-xl p-3 sm:p-4 rounded-xl bg-[#0B192C]/80 border border-slate-700/60 shadow-lg backdrop-blur-md">
                {BRAND.heroCopy}
              </p>

              {/* DYNAMIC HIGH-VISIBILITY ADMIN ANNOUNCEMENT CARD */}
              {announcement && announcement.isActive && (
                <div className="w-full max-w-xl p-2.5 sm:p-4 rounded-xl bg-gradient-to-r from-[#0D1E16] via-[#0B192C] to-[#12231C] border border-amber-500/60 shadow-lg backdrop-blur-xl relative overflow-hidden group">
                  <div className="flex items-center justify-between gap-2.5 relative z-10">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 min-w-0">
                        <span className="hidden xs:inline-block px-2 py-0.5 rounded bg-amber-500/20 text-amber-300 font-extrabold text-[9px] uppercase font-mono tracking-wider border border-amber-500/30 shrink-0">
                          {announcement.badgeText || 'BATCH'}
                        </span>
                    ...
                    {announcement.actionLink && (
                      <a
                        ...
                        className="px-3 py-1.5 rounded-lg bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs flex items-center gap-1 shadow-sm transition-all shrink-0 cursor-pointer active:scale-95 whitespace-nowrap"
                      >
                        <span>{announcement.actionText || 'Enroll'}</span>
