...
const AboutPage = ({ onOpenEnquiry }) => {
  ...
  return (
    <div className="flex flex-col w-full bg-[#07110D] text-[#E2E8F0] overflow-hidden selection:bg-[#F59E0B] selection:text-slate-950">
      ...
      <section className="relative min-h-[calc(100vh-80px)] flex flex-col justify-between pt-8 pb-8 sm:pt-16 sm:pb-10 bg-[#07110D] text-white overflow-hidden border-b border-[#1F3A2E]">
        ...
        <div className="max-w-7xl mx-auto px-3.5 sm:px-6 relative z-10 my-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center text-left">
            ...
            <div className="lg:col-span-7 flex flex-col gap-4 sm:gap-6 ">
              ...
              {/* Title */}
              <h1 className="text-2xl xs:text-3xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-[1.15] font-heading tracking-tight">
                Empowering Traders Through <br className="hidden sm:inline" />
                <span className="bg-gradient-to-r from-[#F59E0B] via-[#FBBF24] to-[#D4AF37] bg-clip-text text-transparent ">Authentic Education & Discipline</span>
              </h1>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3 pt-1">
                ...
                <div className="flex items-center gap-2.5 px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-xl bg-slate-900/90 border border-[#F59E0B]/30 text-xs font-mono font-bold text-slate-100 shadow-md backdrop-blur-md">
                  <Cpu className="w-4 h-4 text-[#F59E0B] shrink-0" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col gap-8 sm:gap-12 text-center relative z-10">
          ...
          <ScrollReveal animation="fade-up">
            <div className="flex flex-col items-center gap-2.5 sm:gap-3">
              <span className="text-[10px] sm:text-xs font-bold text-[#D97706] uppercase tracking-widest px-3 py-1 sm:px-4 sm:py-1.5 rounded-full bg-[#FFFBEB] border border-[#FDE68A] font-mono shadow-2xs">
                OUR CORE VALUES
              </span>
              <h2 className="text-xl sm:text-4xl font-extrabold text-[#0D1B15] font-heading tracking-tight">
            ...
            {coreValues.map((value, idx) => {
              ...
              return (
                <ScrollReveal key={idx} animation="fade-up" delay={idx * 100}>
                  <div className="p-5 sm:p-6 rounded-2xl bg-white border border-slate-200/90 shadow-2xs hover:shadow-lg hover:border-[#F59E0B] transition-all flex flex-col gap-2.5 sm:gap-3 group h-full">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#FFFBEB] border border-[#FDE68A] text-[#D97706] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                      <IconComponent className="w-4 h-4 sm:w-5 sm:h-5" />
                    </div>
                    <h3 className="text-sm sm:text-base font-extrabold text-[#0D1B15] font-heading group-hover:text-[#D97706] transition-colors">{value.title}</h3>
      ...
      <section className="relative py-12 sm:py-24 text-white border-b border-[#1F3A2E] overflow-hidden">
        <div className="absolute inset-0">
          <img src={abstractFinanceBg} alt="" aria-hidden="true" className="w-full h-full object-cover scale-105 blur-sm" />
          <div className="absolute inset-0 bg-[#0D1B15]/90" />
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col gap-8 sm:gap-12 text-center relative z-10">
          
          <ScrollReveal animation="fade-up">
            <div className="flex flex-col items-center gap-2.5 sm:gap-3">
              <span className="text-[10px] sm:text-xs font-bold text-[#F59E0B] uppercase tracking-widest px-3 py-1 sm:px-4 sm:py-1.5 rounded-full bg-slate-900 border border-[#F59E0B]/30 font-mono">
                RESPONSIBLE LEARNING
              </span>
              <h2 className="text-xl sm:text-4xl font-extrabold text-white font-heading tracking-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-left max-w-5xl mx-auto">
            {comparisonData.map((item, idx) => (
              <ScrollReveal key={idx} animation="fade-up" delay={idx * 100}>
                <div className="p-5 sm:p-6 rounded-2xl bg-[#07110D] border-[#1F3A2E] border border-[#1F3A2E] shadow-xl flex flex-col gap-3.5 sm:gap-4 hover:border-[#F59E0B]/50 transition-all h-full">
                  <div className="flex flex-col gap-1.5 border-b border-[#1F3A2E] pb-2.5 sm:pb-3">
      ...
      <section className="py-14 sm:py-28 bg-white text-slate-900 border-t border-slate-200">
        <ScrollReveal animation="scale-in">
          <div className="max-w-4xl mx-auto px-4 text-center flex flex-col items-center gap-5 sm:gap-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full bg-[#FFFBEB] border border-[#FDE68A] text-[#D97706] text-[10.5px] sm:text-xs font-extrabold uppercase tracking-wider">
              <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#D97706]" />
              <span>START YOUR LEARNING JOURNEY</span>
            </div>

            <h2 className="text-xl sm:text-4xl font-extrabold text-[#0D1B15] font-heading leading-tight">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-2 w-full sm:w-auto">
              <Link
                to="/courses"
                className="w-full sm:w-auto px-8 py-3.5 sm:py-4 rounded-xl bg-[#0D1B15] hover:bg-[#12261E] text-[#F59E0B] font-extrabold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-lg transition-all cursor-pointer border border-[#F59E0B]/30"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-8 py-3.5 sm:py-4 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-800 font-extrabold text-xs sm:text-sm flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
