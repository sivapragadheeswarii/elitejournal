          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:col-span-3 gap-6 sm:gap-8">
            ...
            <div className="flex flex-col gap-3">
              ...
              <ul className="flex flex-col gap-2 text-xs text-[#94A3B8] font-semibold">
                ...
                <li><a href="/#market-analysis" onClick={(e) => { e.preventDefault(); document.getElementById('market-analysis')?.scrollIntoView({ behavior: 'smooth' }); }} className="hover:text-white transition-colors flex items-center gap-1.5"><ArrowRight className="w-3 h-3 text-[#F59E0B]/70" /> Market Analysis</a></li>
