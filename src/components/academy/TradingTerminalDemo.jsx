...
const INDICATORS = [
  ...
  { id: 'rsi', name: 'RSI Momentum', color: 'text-emerald-400', desc: 'Detects oversold/overbought momentum reversals' },
...
const TradingTerminalDemo = () => {
  ...
  return (
    <div className="w-full rounded-2xl bg-[#060E1A] border border-slate-700/80 shadow-2xl overflow-hidden relative text-white group">
      ...
      {/* Terminal Top Bar */}
      <div className="px-4 py-3 bg-[#0D1B15] border-b border-[#1F3A2E] flex flex-wrap items-center justify-between gap-3 relative z-10">
      ...
      <div className="p-3 bg-[#081324] border-b border-[#1F3A2E]/90 flex flex-wrap gap-2 relative z-10">
        {INDICATORS.map((ind) => (
          <button
            key={ind.id}
      ...
      <div className="p-5 sm:p-6 relative z-10 flex flex-col gap-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 text-xs font-mono border-b border-[#1F3A2E]/80 pb-3">
        ...
        <div className="relative h-48 sm:h-56 w-full rounded-xl bg-slate-950/80 border border-[#1F3A2E]/90 p-2 overflow-hidden">
          ...
          <div className="absolute top-4 right-4 bg-[#0D1B15]/90 border border-emerald-500/50 p-2.5 rounded-lg shadow-xl backdrop-blur-md flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 pt-2">
          <div className="p-2.5 rounded-xl bg-slate-900/90 border border-[#1F3A2E] text-center">
          ...
          <div className="p-2.5 rounded-xl bg-slate-900/90 border border-[#1F3A2E] text-center">
            ...
            <span className="text-xs font-black text-emerald-400">Minimum 1 : 2.5</span>
          </div>
          <div className="p-2.5 rounded-xl bg-slate-900/90 border border-[#1F3A2E] text-center">
      ...
      {/* Terminal Footer */}
      <div className="px-4 py-2.5 bg-[#0D1B15] border-t border-[#1F3A2E] flex items-center justify-between text-[11px] font-mono text-slate-400 relative z-10">
